package com.microsoft.demo.console;
...
public class SpeechSynthesisSamples {
    private static final String SPEECH_SUB_KEY = "49989ad01d5a434686dd31d82e094496";
    ...
    public static void synthesisToSpeakerAsync() throws InterruptedException, ExecutionException {
        SpeechConfig config = SpeechConfig.fromSubscription(SPEECH_SUB_KEY, SERVICE_REGION);
