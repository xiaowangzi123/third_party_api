...
public class VideoToText2 {
    ...
    public static void speakerIdentification() {
        ...
        String speechSubscriptionKey = "ed7790c795eb47d3a7f1a272ecea684c";
        // Replace below with your own service region (e.g., "westus").
        String serviceRegion = "chinaeast2";
    ...
    public static void speakerVerification() {
        ...
        // Replace below with your own service region (e.g., "westus").
        String serviceRegion = "chinaeast2";
        String audioFile = "https://cloudtranslation.obs.cn-south-1.myhuaweicloud.com/1647943523673.wav";
        ...
        try (SpeechConfig speechConfig = SpeechConfig.fromSubscription(speechSubscriptionKey, serviceRegion);
            ...
            try (VoiceProfile profile = client.createProfileAsync(VoiceProfileType.TextIndependentVerification, "zh-cn").get()) {
