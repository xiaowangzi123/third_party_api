 ...
 * @author wyq
 * @date 2023/5/4
 * @desc 对应大文章，先进行分段，再句法分析
 */
public class SegSplitAndConstituent {
...
//        Annotation annotation = new Annotation("The small red car turned very quickly around the corner.");
        ...
        System.out.println("parse content--->" + System.currentTimeMillis());
        ...
        System.out.println("get sentance--->" + System.currentTimeMillis());
